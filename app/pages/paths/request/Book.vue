    ...
    <dimi-card
          ...
          <div
            ...
            <div
              ...
              <span
                ...
                class="book__item">{{ book.possession ? 'O' : 'X' }}</span>
            </div>
            <div
      ...
      <dimi-modal
        ...
        <div class="modal__field">
          <label class="modal__label">도서명</label>
          <dimi-input
            id="book-title"
            v-model="form.title"/>
        </div>
        ...
        <div class="modal__field">
          <label class="modal__label">작가</label>
          <dimi-input
            id="book-author"
            v-model="form.author"
            class="modal__leftInput"/>
          <label class="modal__label">출판사</label>
          <dimi-input
            id="book-publisher"
        ...
        <div class="modal__field">
          <label
            class="modal__label">가격</label>
          <dimi-input
            id="book-price"
            v-model="form.price"
            class="modal__leftInput"
            placeholder="숫자만 입력하세요"/>
          <label class="modal__label">보유시 사유</label>
          <dimi-input
            id="book-possession"
        ...
        <div class="modal__field">
          <div class="modal__button">
            <dimi-button @click="createBook">추가하기</dimi-button>
          </div>
        </div>
      </dimi-modal>
      <dimi-modal
